...
class SWAT_Def(Tag_Def):
    ...
    Tag_Structure = {TYPE:Container, GUI_NAME:"shader_transparent_water",
                     0:Combine( {1:{ DEFAULT:"swat" },
                                 5:{ DEFAULT:2}
                                 }, Tag_Header),
                     ...
                     1:{TYPE:Struct, SIZE:320, GUI_NAME:"Data",
                        ...
                        4:{ TYPE:Tag_Index_Ref, OFFSET:76, GUI_NAME:"Base Map",
                             INCLUDE:Tag_Index_Ref_Struct
                             },
                        5:{ TYPE:Float, OFFSET:108, GUI_NAME:"Perpendicular Brightness"},#[0,1]
                        6:Combine({OFFSET:112,      GUI_NAME:"Perpendicular Tint Color"}, R_G_B_Float),
                        7:{ TYPE:Float, OFFSET:124, GUI_NAME:"Parallel Brightness"},#[0,1]
                        8:Combine({OFFSET:128,      GUI_NAME:"Parallel Tint Color"}, R_G_B_Float),
                        9:{ TYPE:Tag_Index_Ref, OFFSET:156, GUI_NAME:"Reflection Map",
                             INCLUDE:Tag_Index_Ref_Struct
                             },
                        ...
                        13:{ TYPE:Tag_Index_Ref, OFFSET:200, GUI_NAME:"Ripple Maps",
                             INCLUDE:Tag_Index_Ref_Struct
                             },

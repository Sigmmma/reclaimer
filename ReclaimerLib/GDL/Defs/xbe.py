...
class GDL_XBE_Definition(XBE_Def):
    ...
    Weapon_Types = { TYPE:Bit_Struct, SIZE:4, NAME:"Flags",
                     0:{TYPE:Bit_Enum, NAME:"Weapon_Type", SIZE:4,
                        0:{NAME:"Normal"},
                        1:{NAME:"Fire"},
                        2:{NAME:"Elec"},
                        3:{NAME:"Light"},
                     ...
                     1:{TYPE:Bit_Bool, NAME:"Weapon_Flags", SIZE:28,
    ...
    Tag_Structure = {TYPE:Container, NAME:"Gauntlet_Dark_Legacy_XBE",

                     ...
                     1:{TYPE:Array, GUI_NAME:"Save Files", SIZE:4, MIN:4, MAX:4,
                        SUB_STRUCT:{TYPE:Struct, SIZE:122, GUI_NAME:"Save File",
                                       ...
                                       2:{ TYPE:Enum8, GUI_NAME:"Current Level",
                                           OPTIONS:{ 0:{ GUI_NAME:"Battle of Hoth"},
                                       ...
                                       3:{ TYPE:Bit_Struct, GUI_NAME:"Flags", SIZE:1,
                                           0:{ TYPE:Bit_Enum, GUI_NAME:"Game Beaten", SIZE:1,
                                               OPTIONS:{ 0:{NAME:"No"},
                                                         1:{NAME:"Yes"} } },
                                           1:{ PAD:3 },
                                           2:{ TYPE:Bit_Enum, GUI_NAME:"Game Started", SIZE:1,
                                               OPTIONS:{ 0:{NAME:"No"},
                                                         1:{NAME:"Yes"} } }
                                           },
                                       ...
                                       5:{ TYPE:Bit_Struct, GUI_NAME:"Settings", SIZE:3, ENDIAN:"<",
                                           ...
                                           1:{ PAD:3 },
                                           2:{TYPE:Bit_Enum, GUI_NAME:"Overlay Displays", SIZE:1,
                                              OPTIONS:{ 0:{GUI_NAME:"On"},
                                                        1:{GUI_NAME:"Off"} } },
                                           3:{ PAD:3 },
                                           4:{TYPE:Bit_Enum, GUI_NAME:"Seeker Camera",SIZE:1,
                                              OPTIONS:{ 0:{GUI_NAME:"On"},
                                                        1:{GUI_NAME:"Off"} } },
                                           5:{ PAD:3 },
                                           6:{TYPE:Bit_Enum, GUI_NAME:"SFX Volume", SIZE:2,
                                              OPTIONS:{ 0:{GUI_NAME:"Loud"},
                                                        1:{GUI_NAME:"Medium"},
                                                        2:{GUI_NAME:"Soft"},
                                                        3:{GUI_NAME:"Off"} } },
                                           7:{ PAD:2 },
                                           8:{TYPE:Bit_Enum, GUI_NAME:"Music Volume", SIZE:2,
                                              OPTIONS:{0:{GUI_NAME:"Loud"},
                                                        1:{GUI_NAME:"Medium"},
                                                        2:{GUI_NAME:"Soft"},
                                                        3:{GUI_NAME:"Off"} } },
                                           9:{ PAD:2 },
                                           10:{TYPE:Bit_Enum, GUI_NAME:"Sound Panning", SIZE:1,
                                              OPTIONS:{0:{GUI_NAME:"Stereo"},
                                                        1:{GUI_NAME:"Mono"} } }
                                           },
                                       
                                       6:{ TYPE:Big_Enum, GUI_NAME:"Control Scheme", SIZE:3,
                                           OPTIONS:{ 0:{GUI_NAME:"Standard", VALUE:0},
                                       ...
                                       7:{ TYPE:Big_Enum, GUI_NAME:"Button Mapping", SIZE:3,
                                           OPTIONS:{ 0:{GUI_NAME:"Standard", VALUE:0x000000},

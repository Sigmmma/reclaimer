...
class OBJECTS_PS2_Definition(Tag_Def):
    ...
    Object_Block = { TYPE:Struct, SIZE:64, GUI_NAME:"Object",
                     ...
                     2:{ TYPE:Bool32, OFFSET:8, GUI_NAME:"Flags",
                         OPTIONS: { 0:{ NAME:"Non_Lit",   VALUE:0x0 },
    ...
    Bitmap_Block = { TYPE:Struct, SIZE:64, GUI_NAME:"Bitmap",
                     ...
                     0:{ TYPE:Enum8,  OFFSET:0, GUI_NAME:"Bitmap Format",
                         OPTIONS:{ 0:{NAME:"ABGR_1555", VALUE:0 },
                     ...
                     6:{ TYPE:Bool16, OFFSET:8, GUI_NAME:"Flags",
                         OPTIONS: { 0:{NAME:"Halfres",   VALUE:0x1},

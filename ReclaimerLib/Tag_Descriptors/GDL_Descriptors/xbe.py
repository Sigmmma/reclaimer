...
class GDL_XBE_Definition(XBE_Def):
    ...
    Special_Types = { TYPE:UInt32, GUI_NAME:"Special Type",
                      FLAGS:{ 0:{GUI_NAME:"Levitate", VALUE:1},
    ...
    Armor_Types = { TYPE:UInt32, GUI_NAME:"Armor Type",
                    FLAGS:{ 0:{GUI_NAME:"Resist Fire", VALUE:1},
    ...
    Weapon_Types = { TYPE:Bit_Struct, SIZE:32, GUI_NAME:"Weapon Properties",
                     0:{TYPE:Bit_UInt, GUI_NAME:"Weapon Type", SIZE:4,
                     ...
                     1:{TYPE:Bit_UInt, GUI_NAME:"Weapon Flags", SIZE:28,
                        FLAGS:{ 0:{GUI_NAME:"Knockback", VALUE:16},
    ...
    Weapon_Flags = { TYPE:UInt32, GUI_NAME:"Weapon Properties", SIZE:4,
                     FLAGS:{ 0:{GUI_NAME:"Knockback", VALUE:16},
                             1:{GUI_NAME:"Knockdown", VALUE:32},
                             2:{GUI_NAME:"Whirlwind", VALUE:65536},
                             3:{GUI_NAME:"Three Way", VALUE:524288},

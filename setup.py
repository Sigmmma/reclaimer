...
setup(
    ...
    packages=[
        ...
        'reclaimer.halo_script.defs',
        'reclaimer.hek',
        'reclaimer.hek.defs',
        'reclaimer.hek.defs.objs',
        'reclaimer.mcc_hek',
        'reclaimer.mcc_hek.defs',
        'reclaimer.mcc_hek.defs.objs',
        'reclaimer.meta',
        ...
        'reclaimer.shadowrun_prototype.defs.objs',
        'reclaimer.strings',
        'reclaimer.stubbs',
    ...
    install_requires=['supyr_struct>=1.5.0', 'binilla', 'arbytmap', 'simpleaudio', 'pyogg'],
    requires=['supyr_struct', 'binilla', 'arbytmap', 'simpleaudio', 'pyogg'],
    provides=['reclaimer'],
    python_requires=">=3.5",
    classifiers=[

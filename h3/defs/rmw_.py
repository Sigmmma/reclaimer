...
rmw__import_data = Struct("import_data", 
    ...
    reflexive("functions", rmw__import_data_function),
    ENDIAN=">", SIZE=60
    )
...
rmw__shader_propertie = Struct("shader_propertie", 
    dependency("template"),
    reflexive("shader_maps", rmw__shader_propertie_shader_map),
    reflexive("arguments", rmw__shader_propertie_argument),
    reflexive("unknown_0", rmw__shader_propertie_unknown_0),
    BytesRaw("unknown_1", SIZE=4, VISIBLE=False),
    reflexive("unknown_2", rmw__shader_propertie_unknown_2),
    reflexive("unknown_3", rmw__shader_propertie_unknown_3),
    reflexive("unknown_4", rmw__shader_propertie_unknown_4),
    reflexive("functions", rmw__shader_propertie_function),
...
rmw__meta_def = BlockDef("rmw_", 
    ...
    reflexive("unknown_0", rmw__unknown_0),
    reflexive("import_data", rmw__import_data),
    reflexive("shader_properties", rmw__shader_propertie),

...
term_body = Struct("tagdata", 
    ...
    h3_reflexive("early_mover_properties", term_early_mover_propertie),
    h3_dependency("creation_effect"),
    h3_dependency("material_effects"),
    h3_dependency("melee_impact"),
    h3_reflexive("ai_properties", term_ai_propertie),
    h3_reflexive("functions", term_function),
    SInt16("hud_text_message_index"),
    SInt16("unknown_1", VISIBLE=False),
    h3_reflexive("attachments", term_attachment),
    h3_reflexive("widgets", term_widget),
    ...
    h3_dependency("activation_sound"),
    h3_dependency("deactivation_sound"),
    h3_dependency("translate_sound"),
    h3_dependency("translate_sound_2"),

...
scnr_bsp_group_bsps_0_clusters_0_bsp = Struct("bsp", 
    reflexive("unknown", scnr_bsp_group_bsps_0_clusters_0_bsp_unknown),
    ENDIAN=">", SIZE=12
    )


scnr_bsp_group_bsps_0_clusters_0 = Struct("clusters_0", 
    reflexive("bsps", scnr_bsp_group_bsps_0_clusters_0_bsp),
    ENDIAN=">", SIZE=12
    )
...
scnr_bsp_group_bsps_0_clusters_1_bsp = Struct("bsp", 
    reflexive("unknown", scnr_bsp_group_bsps_0_clusters_1_bsp_unknown),
    ENDIAN=">", SIZE=12
    )


scnr_bsp_group_bsps_0_clusters_1 = Struct("clusters_1", 
    reflexive("bsps", scnr_bsp_group_bsps_0_clusters_1_bsp),
    ENDIAN=">", SIZE=12
    )
...
scnr_bsp_group_bsps_0_clusters_2 = Struct("clusters_2", 
    reflexive("unknown", scnr_bsp_group_bsps_0_clusters_2_unknown),
    VISIBLE=False,
    ENDIAN=">", SIZE=12
    )
...
scnr_bsp_group_bsps_0 = Struct("bsps_0", 
    reflexive("clusters_0", scnr_bsp_group_bsps_0_clusters_0),
    reflexive("clusters_1", scnr_bsp_group_bsps_0_clusters_1),
    reflexive("cluster_skies", scnr_bsp_group_bsps_0_cluster_skie),
    reflexive("cluster_visible_skies", scnr_bsp_group_bsps_0_cluster_visible_skie),
    BytesRaw("unknown_0", SIZE=12, VISIBLE=False),
    reflexive("unknown_1", scnr_bsp_group_bsps_0_unknown_1),
    reflexive("clusters_2", scnr_bsp_group_bsps_0_clusters_2),
    ENDIAN=">", SIZE=84
    )
...
scnr_bsp_group_bsps_1 = Struct("bsps_1", 
    reflexive("unknown_0", scnr_bsp_group_bsps_1_unknown_0),
...
scnr_bsp_group = Struct("bsp_group", 
    ...
    reflexive("bsps_0", scnr_bsp_group_bsps_0),
...
scnr_light_volume = Struct("light_volume", 
    ...
    UInt16("unique_id_index"),
    SInt16("origin_bsp_index"),
    SEnum8("type_0", *scnr_scenery_type),
    SEnum8("source", *scnr_scenery_source),
    SEnum8("bsp_policy", *scnr_scenery_bsp_policy),
    SInt8("unknown_1", VISIBLE=False),
    SInt16("editor_folder_index"),
...
scnr_ai_pathfinding_data = Struct("ai_pathfinding_data", 
    reflexive("unknown_0", scnr_ai_pathfinding_data_unknown_0),
...
scnr_scenario_resource_script_source = Struct("script_source", 
    dependency("hs_source_file", VISIBLE=False),
    VISIBLE=False,
    ENDIAN=">", SIZE=16
    )
...
scnr_scenario_resource_ai_resource = Struct("ai_resource", 
    dependency("ai_resource", VISIBLE=False),
    VISIBLE=False,
    ENDIAN=">", SIZE=16
    )
...
scnr_scenario_resource_reference = Struct("reference", 
    dependency("scenery_resource", VISIBLE=False),
    dependency("bipeds_resource", VISIBLE=False),
    dependency("vehicles_resource", VISIBLE=False),
    dependency("equipment_resource", VISIBLE=False),
    dependency("weapons_resource", VISIBLE=False),
    dependency("sound_scenery_resource", VISIBLE=False),
    dependency("lights_resource", VISIBLE=False),
    dependency("devices_resource", VISIBLE=False),
    dependency("effect_scenery_resource", VISIBLE=False),
    dependency("decals_resource", VISIBLE=False),
    dependency("cinematics_resource", VISIBLE=False),
    dependency("trigger_volumes_resource", VISIBLE=False),
    dependency("cluster_data_resource", VISIBLE=False),
    dependency("comments_resource", VISIBLE=False),
    dependency("creature_resource", VISIBLE=False),
    dependency("structure_lighting_resource", VISIBLE=False),
    dependency("decorators_resource", VISIBLE=False),
    dependency("sky_references_resource", VISIBLE=False),
    dependency("cubemap_resource", VISIBLE=False),
    VISIBLE=False,
    ENDIAN=">", SIZE=304
    )
...
scnr_scenario_cluster_data = Struct("scenario_cluster_data", 
    ...
    reflexive("unknown_0", scnr_scenario_cluster_data_unknown_0),
...
scnr_ai_objective_role = Struct("role", 
    ...
    reflexive("unknown_8", scnr_ai_objective_role_unknown_8),

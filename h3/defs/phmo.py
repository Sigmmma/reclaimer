...
phmo_unknown_4 = Struct("unknown_4", 
    reflexive("unknown_0", phmo_unknown_4_unknown_0),
    reflexive("unknown_1", phmo_unknown_4_unknown_1),
    VISIBLE=False,
    ENDIAN=">", SIZE=24
    )
...
phmo_node_edge_constraint = Struct("constraint", 
    ...
    Float("friction"),
    reflexive("unknown_0", phmo_node_edge_constraint_unknown_0),
...
phmo_meta_def = BlockDef("phmo", 
    ...
    reflexive("unknown_2", phmo_unknown_2),
    reflexive("unknown_3", phmo_unknown_3),
    reflexive("phantom_types", phmo_phantom_type),
    reflexive("unknown_4", phmo_unknown_4),

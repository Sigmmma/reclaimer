...
sbsp_body = Struct("tagdata", 
    ...
    h3_reflexive("unknown_1", sbsp_unknown_1),
    h3_reflexive("cluster_portals", sbsp_cluster_portal),
    h3_reflexive("unknown_2", sbsp_unknown_2),
    ...
    BytesRaw("unknown_5", SIZE=44, VISIBLE=False),
    h3_reflexive("markers", sbsp_marker),
    h3_reflexive("lights", sbsp_light),
    h3_reflexive("unknown_6", sbsp_unknown_6),
    ...
    SInt32("useless_padding_0", VISIBLE=False),
    ...
    h3_reflexive("unknown_17", sbsp_unknown_17),
    ...
    h3_reflexive("unknown_19", sbsp_unknown_19),
    ...
    SInt32("useless_padding_1", VISIBLE=False),

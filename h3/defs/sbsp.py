...
sbsp_meshes_0_index_buffer_type = (
    "point_list",
    "line_list",
    "line_strip",
    "triange_list",
...
sbsp_structure_seam = Struct("structure_seam", 
    ...
    reflexive("unknown", sbsp_structure_seam_unknown),
...
sbsp_detail_object_unknown_1 = Struct("unknown_1", 
    reflexive("unknown_0", sbsp_detail_object_unknown_1_unknown_0),
...
sbsp_cluster = Struct("cluster", 
    ...
    reflexive("unknown_11", sbsp_cluster_unknown_11),
    reflexive("unknown_12", sbsp_cluster_unknown_12),
    ENDIAN=">", SIZE=220
    )
...
sbsp_meshes_0_instanced_geometry_indice = Struct("instanced_geometry_indice", 
    ...
    reflexive("instanced_geometry_mesh_contents", sbsp_meshes_0_instanced_geometry_indice_instanced_geometry_mesh_content),
    ENDIAN=">", SIZE=16
    )
...
sbsp_meshes_0 = Struct("meshes_0", 
    reflexive("parts", sbsp_meshes_0_part),
    reflexive("subparts", sbsp_meshes_0_subpart),
    ...
    SInt8("rigid_node"),
    SEnum8("vertex_type", *sbsp_meshes_0_vertex_type),
    SEnum8("prt_type", *sbsp_meshes_0_prt_type),
    SEnum8("index_buffer_type", *sbsp_meshes_0_index_buffer_type),
    SInt8("unknown_0", VISIBLE=False),
    SInt8("unknown_1", VISIBLE=False),
    SInt8("unknown_2", VISIBLE=False),
    reflexive("instanced_geometry_indices", sbsp_meshes_0_instanced_geometry_indice),
    reflexive("unknown_water", sbsp_meshes_0_unknown_water),
    ENDIAN=">", SIZE=76
    )
...
sbsp_unknown_meshes_0 = Struct("unknown_meshes_0", 
    ...
    reflexive("unknown_1", sbsp_unknown_meshes_0_unknown_1),
    VISIBLE=False,
    ENDIAN=">", SIZE=32
    )
...
sbsp_node_maps_0 = Struct("node_maps_0", 
    reflexive("unknown", sbsp_node_maps_0_unknown),
    ENDIAN=">", SIZE=12
    )
...
sbsp_meta_def = BlockDef("sbsp", 
    ...
    reflexive("unknown_2", sbsp_unknown_1),
    reflexive("cluster_portals", sbsp_cluster_portal),
    reflexive("unknown_3", sbsp_unknown_2),
    ...
    reflexive("unknown_7", sbsp_unknown_6),
    ...
    reflexive("meshes_0", sbsp_meshes_0),
    reflexive("compression_info_0", sbsp_compression_info_0),
    reflexive("unknown_nodey_0", sbsp_unknown_nodey_0),
    reflexive("unknown_10", sbsp_unknown_9),
    BytesRaw("unknown_11", SIZE=12, VISIBLE=False),
    reflexive("unknown_meshes_0", sbsp_unknown_meshes_0),
    reflexive("node_maps_0", sbsp_node_maps_0),
    reflexive("unknown_12", sbsp_unknown_11),
    BytesRaw("unknown_13", SIZE=12, VISIBLE=False),
    reflexive("unknown_yo_0", sbsp_unknown_yo_0),
    ...
    reflexive("unknown_18", sbsp_unknown_17),
    ...
    reflexive("unknown_20", sbsp_unknown_19),

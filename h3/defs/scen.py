...
scen_ai_propertie_leap_jump_speed = (
    "none",
    "down",
    "step",
    "crouch",
...
scen_lightmap_shadow_mode_size = (
    "default",
    "never",
    "always",
    "unknown",
...
scen_lightmapping_policy = (
    "per_vertex",
    "per_pixel_not_implemented",
    "dynamic",
    )

scen_multiplayer_object_propertie_object_type = (
    "ordinary",
    "weapon",
    "grenade",
    "projectile",
...
scen_multiplayer_object_propertie_shape = (
    "none",
    "sphere",
    "cylinder",
    "box",
...
scen_multiplayer_object_propertie_spawn_timer_mode = (
    "on_death",
    "on_disturbance",
    )
...
scen_early_mover_propertie = Struct("early_mover_properties",
    string_id_meta("name"),
    Pad(36),
    ENDIAN=">", SIZE=40
    )
...
scen_ai_propertie = Struct("ai_properties",
    Bool32("flags",
        "destroyable_cover",
    ...
    Pad(4),
    SEnum16("size", *scen_ai_propertie_size),
    SEnum16("leap_jump_speed", *scen_ai_propertie_leap_jump_speed),
    ENDIAN=">", SIZE=16
    )


scen_function = Struct("functions",
    Bool32("flags",
        "invert",
...
scen_attachment = Struct("attachments",
    dependency("attachment"),
    string_id_meta("marker"),
    SEnum16("change_color", *scen_attachment_change_color),
    SInt16("unknown"),
...
scen_widget = Struct("widgets",
    dependency("type"),
    ENDIAN=">", SIZE=16
    )


scen_change_color_initial_permutation = Struct("initial_permutations",
    Pad(4),
...
scen_change_color_function = Struct("functions",
    Bool32("scale_flags",
        "blend_in_hsv",
        "more_colors",
        ),
...
scen_change_color = Struct("change_colors",
    reflexive("initial_permutations", scen_change_color_initial_permutation),
    reflexive("functions", scen_change_color_function),
    ENDIAN=">", SIZE=24
    )


scen_predicted_resource = Struct("predicted_resources",
    SInt16("type"),
...
scen_multiplayer_object_propertie = Struct("multiplayer_object_properties",
    Bool16("engine_flags",
        "capture_the_flag",
        "slayer",
        "oddball",
    ...
    SEnum8("object_type", *scen_multiplayer_object_propertie_object_type),
    ...
    SEnum8("shape", *scen_multiplayer_object_propertie_shape),
    SEnum8("spawn_timer_mode", *scen_multiplayer_object_propertie_spawn_timer_mode),
    SInt16("spawn_time"),
    SInt16("abandon_time"),
    Float("radius_width"),
    Float("length"),
...
scen_meta_def = BlockDef("scen",
    SEnum16("object_type", *scen_object_type),
    Bool16("flags",
    ...
    SEnum16("lightmap_shadow_mode_size", *scen_lightmap_shadow_mode_size),
    SEnum8("sweetener_size", *scen_sweetener_size),
    SEnum8("water_density", *scen_water_density),
    SInt32("unknown"),
    ...
    reflexive("early_mover_properties", scen_early_mover_propertie),
    dependency("creation_effect"),
    dependency("material_effects"),
    dependency("melee_impact"),
    reflexive("ai_properties", scen_ai_propertie),
    reflexive("functions", scen_function),
    SInt16("hud_text_message_index"),
    SInt16("unknown_1"),
    reflexive("attachments", scen_attachment),
    reflexive("widgets", scen_widget),
    reflexive("change_colors", scen_change_color),
    reflexive("predicted_resources", scen_predicted_resource),
    reflexive("multiplayer_object_properties", scen_multiplayer_object_propertie),

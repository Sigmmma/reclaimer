...
ugh__custom_playback = Struct("custom_playback", 
    ...
    reflexive("filter", ugh__custom_playback_filter),
...
ugh__language = Struct("language", 
    ...
    reflexive("unknown_a", ugh__language_unknown_a),
    reflexive("unknown_b", ugh__language_unknown_b),
    ENDIAN=">", SIZE=28
    )
...
ugh__promotion = Struct("promotion", 
    reflexive("rules", ugh__promotion_rule),
    reflexive("runtime_timers", ugh__promotion_runtime_timer),
    SInt32("unknown_0", VISIBLE=False),
    BytesRaw("unknown_1", SIZE=8, VISIBLE=False),
    ENDIAN=">", SIZE=36
    )
...
ugh__extra_info_encoded_permutation_section_unknown_unknown = Struct("unknown", 
    Pad(16),
    reflexive("unknown_1", ugh__extra_info_encoded_permutation_section_unknown_unknown_unknown_1),
    reflexive("unknown_2", ugh__extra_info_encoded_permutation_section_unknown_unknown_unknown_2),
    ENDIAN=">", SIZE=40
    )


ugh__extra_info_encoded_permutation_section_unknown = Struct("unknown", 
    reflexive("unknown", ugh__extra_info_encoded_permutation_section_unknown_unknown),
    ENDIAN=">", SIZE=12
    )
...
ugh__extra_info_encoded_permutation_section = Struct("encoded_permutation_section", 
    ...
    reflexive("sound_dialogue_info", ugh__extra_info_encoded_permutation_section_sound_dialogue_info),
    reflexive("unknown", ugh__extra_info_encoded_permutation_section_unknown),
    ENDIAN=">", SIZE=44
    )


ugh__extra_info = Struct("extra_info", 
    reflexive("encoded_permutation_sections", ugh__extra_info_encoded_permutation_section),
    ENDIAN=">", SIZE=12
    )


ugh__meta_def = BlockDef("ugh_", 
    reflexive("platform_codec", ugh__platform_codec),
    reflexive("playback_parameters", ugh__playback_parameter),
    reflexive("scales", ugh__scale),
    reflexive("import_names", ugh__import_name),
    reflexive("pitch_range_parameters", ugh__pitch_range_parameter),
    reflexive("pitch_ranges", ugh__pitch_range),
    reflexive("permutations", ugh__permutation),
    reflexive("custom_playbacks", ugh__custom_playback),
    reflexive("languages", ugh__language),
    reflexive("runtime_permutation_flags", ugh__runtime_permutation_flag),
    rawdata_ref("unknown_0", VISIBLE=False),
    BytesRaw("unknown_1", SIZE=8, VISIBLE=False),
    reflexive("permutation_chunks", ugh__permutation_chunk),
    reflexive("promotions", ugh__promotion),
    reflexive("extra_info", ugh__extra_info),

...
ssce_early_mover_propertie = Struct("early_mover_propertie", 
    h3_string_id("name"),
    Pad(36),
    ENDIAN=">", SIZE=40
    )
...
ssce_ai_propertie = Struct("ai_propertie", 
    Bool32("flags", 
        "destroyable_cover",
...
ssce_attachment = Struct("attachment", 
...
ssce_widget = Struct("widget", 
    h3_dependency("type"),
    ENDIAN=">", SIZE=16
    )


ssce_change_color_initial_permutation = Struct("initial_permutation", 
    Pad(4),
...
ssce_change_color_function = Struct("function", 
    Bool32("scale_flags", 
        "blend_in_hsv",
        "more_colors",
        ),
...
ssce_change_color = Struct("change_color", 
    h3_reflexive("initial_permutations", ssce_change_color_initial_permutation),
    h3_reflexive("functions", ssce_change_color_function),
    ENDIAN=">", SIZE=24
    )


ssce_predicted_resource = Struct("predicted_resource", 
    SInt16("type"),
...
ssce_multiplayer_object_propertie = Struct("multiplayer_object_propertie", 
    Bool16("engine_flags", 
        "capture_the_flag",
        "slayer",
        "oddball",

...
ctrl_early_mover_propertie = Struct("early_mover_properties",
    string_id_meta("name"),
    Pad(36),
    ENDIAN=">", SIZE=40
    )
...
ctrl_ai_propertie = Struct("ai_properties",
    Bool32("flags",
        "destroyable_cover",
...
ctrl_function = Struct("functions",
    Bool32("flags",
        "invert",
...
ctrl_attachment = Struct("attachments",
...
ctrl_widget = Struct("widgets",
    dependency("type"),
    ENDIAN=">", SIZE=16
    )


ctrl_change_color_initial_permutation = Struct("initial_permutations",
    Pad(4),
...
ctrl_change_color_function = Struct("functions",
    Bool32("scale_flags",
        "blend_in_hsv",
        "more_colors",
        ),
...
ctrl_change_color = Struct("change_colors",
...
ctrl_predicted_resource = Struct("predicted_resources",
    SInt16("type"),
...
ctrl_multiplayer_object_propertie = Struct("multiplayer_object_properties",
    Bool16("engine_flags",
        "capture_the_flag",
        "slayer",
        "oddball",

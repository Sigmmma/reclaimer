...
effe_event_particle_system_emitter_output_kind_0 = (
    "none",
    "plus",
    "times",
    )
...
effe_event_particle_system_emitter_unknown_21_unknown_1 = Struct("unknown_1", 
    ...
    SInt8("input"),
    SInt8("input_range"),
    SEnum8("output_kind", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output"),
...
effe_event_particle_system_emitter_unknown_21 = Struct("unknown_21", 
    BytesRaw("unknown_0", SIZE=4, VISIBLE=False),
    reflexive("unknown_1", effe_event_particle_system_emitter_unknown_21_unknown_1),
    BytesRaw("unknown_2", SIZE=8, VISIBLE=False),
    VISIBLE=False,
    ENDIAN=">", SIZE=24
    )
...
effe_event_particle_system_emitter = Struct("emitter", 
    ...
    SInt8("input_0"),
    SInt8("input_range_0"),
    SEnum8("output_kind_0", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_0"),
    rawdata_ref("unknown_3"),
    BytesRaw("unknown_4", SIZE=32, VISIBLE=False),
    SInt8("input_1"),
    SInt8("input_range_1"),
    SEnum8("output_kind_1", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_1"),
    rawdata_ref("unknown_5"),
    BytesRaw("unknown_6", SIZE=32, VISIBLE=False),
    SInt8("input_2"),
    SInt8("input_range_2"),
    SEnum8("output_kind_2", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_2"),
    rawdata_ref("unknown_7"),
    BytesRaw("unknown_8", SIZE=8, VISIBLE=False),
    SInt8("input_3"),
    SInt8("input_range_3"),
    SEnum8("output_kind_3", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_3"),
    rawdata_ref("unknown_9"),
    BytesRaw("unknown_10", SIZE=8, VISIBLE=False),
    SInt8("input_4"),
    SInt8("input_range_4"),
    SEnum8("output_kind_4", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_4"),
    rawdata_ref("unknown_11"),
    BytesRaw("unknown_12", SIZE=8, VISIBLE=False),
    SInt8("input_5"),
    SInt8("input_range_5"),
    SEnum8("output_kind_5", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_5"),
    rawdata_ref("unknown_13"),
    BytesRaw("unknown_14", SIZE=8, VISIBLE=False),
    SInt8("input_6"),
    SInt8("input_range_6"),
    SEnum8("output_kind_6", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_6"),
    rawdata_ref("unknown_15"),
    BytesRaw("unknown_16", SIZE=8, VISIBLE=False),
    SInt8("input_7"),
    SInt8("input_range_7"),
    SEnum8("output_kind_7", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_7"),
    rawdata_ref("unknown_17"),
    BytesRaw("unknown_18", SIZE=8, VISIBLE=False),
    SInt8("input_8"),
    SInt8("input_range_8"),
    SEnum8("output_kind_8", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_8"),
    rawdata_ref("unknown_19"),
    BytesRaw("unknown_20", SIZE=8, VISIBLE=False),
    dependency("particle_physics"),
    Array("unknown_array", SUB_STRUCT=SInt8("unknown"), SIZE=4, VISIBLE=False),
    reflexive("unknown_21", effe_event_particle_system_emitter_unknown_21),
    SInt8("input_9"),
    SInt8("input_range_9"),
    SEnum8("output_kind_9", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_9"),
    rawdata_ref("unknown_22"),
    BytesRaw("unknown_23", SIZE=32, VISIBLE=False),
    SInt8("input_10"),
    SInt8("input_range_10"),
    SEnum8("output_kind_10", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_10"),
    rawdata_ref("unknown_24"),
    BytesRaw("unknown_25", SIZE=8, VISIBLE=False),
    SInt8("input_11"),
    SInt8("input_range_11"),
    SEnum8("output_kind_11", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_11"),
    rawdata_ref("unknown_26"),
    BytesRaw("unknown_27", SIZE=8, VISIBLE=False),
    SInt8("input_12"),
    SInt8("input_range_12"),
    SEnum8("output_kind_12", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_12"),
    rawdata_ref("unknown_28"),
    BytesRaw("unknown_29", SIZE=8, VISIBLE=False),
    SInt8("input_13"),
    SInt8("input_range_13"),
    SEnum8("output_kind_13", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_13"),
    rawdata_ref("unknown_30"),
    BytesRaw("unknown_31", SIZE=8, VISIBLE=False),
    SInt8("input_14"),
    SInt8("input_range_14"),
    SEnum8("output_kind_14", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_14"),
    rawdata_ref("particle_scale"),
    BytesRaw("unknown_32", SIZE=8, VISIBLE=False),
    SInt8("input_15"),
    SInt8("input_range_15"),
    SEnum8("output_kind_15", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_15"),
    rawdata_ref("particle_tint"),
    BytesRaw("unknown_33", SIZE=8, VISIBLE=False),
    SInt8("input_16"),
    SInt8("input_range_16"),
    SEnum8("output_kind_16", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_16"),
    rawdata_ref("particle_alpha"),
    BytesRaw("unknown_34", SIZE=8, VISIBLE=False),
    SInt8("input_17"),
    SInt8("input_range_17"),
    SEnum8("output_kind_17", *effe_event_particle_system_emitter_output_kind_0),
    SInt8("output_17"),
    ...
    reflexive("unknown_39", effe_event_particle_system_emitter_unknown_39),
...
effe_meta_def = BlockDef("effe", 
    ...
    reflexive("unknown_9", effe_unknown_9),

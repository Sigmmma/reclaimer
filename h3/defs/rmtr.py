...
rmtr_shader_propertie = Struct("shader_propertie", 
    ...
    reflexive("unknown_0", rmtr_shader_propertie_unknown_0),
    BytesRaw("unknown_1", SIZE=4, VISIBLE=False),
...
rmtr_meta_def = BlockDef("rmtr", 
    ...
    reflexive("unknown_0", rmtr_unknown_0),
    ...
    BytesRaw("unknown_1", SIZE=4, VISIBLE=False),
    SInt32("unknown_2", VISIBLE=False),
    Array("material_array", SUB_STRUCT=string_id_meta("material"), SIZE=4, VISIBLE=False),

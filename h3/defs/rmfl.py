...
rmfl_unknown_0 = Struct("unknown_0", 
...
rmfl_import_data_function = Struct("function", 
...
rmfl_import_data = Struct("import_data", 
    ...
    h3_reflexive("functions", rmfl_import_data_function),
    ENDIAN=">", SIZE=60
    )


rmfl_shader_propertie_shader_map = Struct("shader_map", 
    h3_dependency("bitmap"),
...
rmfl_shader_propertie_argument = Struct("argument", 
    Array("arg_array", SUB_STRUCT=Float("arg"), SIZE=4),
    ENDIAN=">", SIZE=16
    )


rmfl_shader_propertie_unknown_0 = Struct("unknown_0", 
...
rmfl_shader_propertie_function = Struct("function", 
    SInt32("unknown_0", VISIBLE=False),
    h3_string_id("name"),
    BytesRaw("unknown_1", SIZE=8, VISIBLE=False),
    h3_rawdata_ref("function"),
...
rmfl_shader_propertie = Struct("shader_propertie", 
    h3_dependency("template"),
    h3_reflexive("shader_maps", rmfl_shader_propertie_shader_map),
    h3_reflexive("arguments", rmfl_shader_propertie_argument),
    h3_reflexive("unknown_0", rmfl_shader_propertie_unknown_0),
    BytesRaw("unknown_1", SIZE=4, VISIBLE=False),
    h3_reflexive("unknown_2", rmfl_shader_propertie_unknown_2),
    h3_reflexive("unknown_3", rmfl_shader_propertie_unknown_3),
    h3_reflexive("unknown_4", rmfl_shader_propertie_unknown_4),
    h3_reflexive("functions", rmfl_shader_propertie_function),
...
rmfl_body = Struct("tagdata", 
    h3_dependency("base_render_method"),
    h3_reflexive("unknown_0", rmfl_unknown_0),
    h3_reflexive("import_data", rmfl_import_data),
    h3_reflexive("shader_properties", rmfl_shader_propertie),
...
rmfl_def = TagDef("rmfl",
    h3_blam_header('rmfl'),
    rmfl_body,

    ext=".%s" % h3_tag_class_fcc_to_ext["rmfl"], endian=">", tag_cls=H3Tag
    )
...
chdt_hud_widget_bitmap_widget = Struct("bitmap_widgets",
    string_id_meta("name"),
    SEnum16("special_hud_type", *chdt_hud_widget_special_hud_type),
    UInt8("unknown"),
    UInt8("unknown_1"),
    reflexive("state_data", chdt_hud_widget_bitmap_widget_state_data),
    reflexive("placement_data", chdt_hud_widget_bitmap_widget_placement_data),
    reflexive("animation_data", chdt_hud_widget_bitmap_widget_animation_data),
    reflexive("render_data", chdt_hud_widget_bitmap_widget_render_data),
    SInt32("widget_index"),
    Bool16("flags",
        "mirror_horizontally",
        "mirror_vertically",
...
chdt_hud_widget_text_widget = Struct("text_widgets",
    string_id_meta("name"),
    SEnum16("special_hud_type", *chdt_hud_widget_special_hud_type),
    UInt8("unknown"),
    UInt8("unknown_1"),
    reflexive("state_data", chdt_hud_widget_text_widget_state_data),
    reflexive("placement_data", chdt_hud_widget_text_widget_placement_data),
    reflexive("animation_data", chdt_hud_widget_text_widget_animation_data),
    reflexive("render_data", chdt_hud_widget_text_widget_render_data),
    SInt32("widget_index"),
    Bool16("flags",
        "string_is_a_number",
        "force_2_digit",
    ...
    string_id_meta("string"),
    ENDIAN=">", SIZE=68
    )


chdt_hud_widget = Struct("hud_widgets",
    string_id_meta("name"),
    SEnum16("special_hud_type", *chdt_hud_widget_special_hud_type),
    UInt8("unknown"),
    UInt8("unknown_1"),
    reflexive("state_data", chdt_hud_widget_state_data),
    reflexive("placement_data", chdt_hud_widget_placement_data),
    reflexive("animation_data", chdt_hud_widget_animation_data),
    reflexive("render_data", chdt_hud_widget_render_data),
    reflexive("bitmap_widgets", chdt_hud_widget_bitmap_widget),
    reflexive("text_widgets", chdt_hud_widget_text_widget),
    ENDIAN=">", SIZE=80
    )


chdt_meta_def = BlockDef("chdt",
    reflexive("hud_widgets", chdt_hud_widget),

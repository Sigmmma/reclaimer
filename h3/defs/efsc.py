...
efsc_ai_propertie_leap_jump_speed = (
    "none",
    "down",
    "step",
    "crouch",
...
efsc_lightmap_shadow_mode_size = (
    "default",
    "never",
    "always",
    "unknown",
...
efsc_multiplayer_object_propertie_object_type = (
    "ordinary",
    "weapon",
    "grenade",
    "projectile",
...
efsc_multiplayer_object_propertie_shape = (
    "none",
    "sphere",
    "cylinder",
    "box",
...
efsc_multiplayer_object_propertie_spawn_timer_mode = (
    "on_death",
    "on_disturbance",
    )
...
efsc_early_mover_propertie = Struct("early_mover_properties",
    string_id_meta("name"),
    Pad(36),
    ENDIAN=">", SIZE=40
    )
...
efsc_ai_propertie = Struct("ai_properties",
    Bool32("flags",
        "destroyable_cover",
    ...
    Pad(4),
    SEnum16("size", *efsc_ai_propertie_size),
    SEnum16("leap_jump_speed", *efsc_ai_propertie_leap_jump_speed),
    ENDIAN=">", SIZE=16
    )


efsc_function = Struct("functions",
    Bool32("flags",
        "invert",
...
efsc_attachment = Struct("attachments",
    dependency("attachment"),
    string_id_meta("marker"),
    SEnum16("change_color", *efsc_attachment_change_color),
    SInt16("unknown"),
...
efsc_widget = Struct("widgets",
    dependency("type"),
    ENDIAN=">", SIZE=16
    )


efsc_change_color_initial_permutation = Struct("initial_permutations",
    Pad(4),
...
efsc_change_color_function = Struct("functions",
    Bool32("scale_flags",
        "blend_in_hsv",
        "more_colors",
        ),
...
efsc_change_color = Struct("change_colors",
    reflexive("initial_permutations", efsc_change_color_initial_permutation),
    reflexive("functions", efsc_change_color_function),
    ENDIAN=">", SIZE=24
    )


efsc_predicted_resource = Struct("predicted_resources",
    SInt16("type"),
...
efsc_multiplayer_object_propertie = Struct("multiplayer_object_properties",
    Bool16("engine_flags",
        "capture_the_flag",
        "slayer",
        "oddball",
    ...
    SEnum8("object_type", *efsc_multiplayer_object_propertie_object_type),
    ...
    SEnum8("shape", *efsc_multiplayer_object_propertie_shape),
    SEnum8("spawn_timer_mode", *efsc_multiplayer_object_propertie_spawn_timer_mode),
    SInt16("spawn_time"),
    SInt16("abandon_time"),
    Float("radius_width"),
    Float("length"),
...
efsc_meta_def = BlockDef("efsc",
    SEnum16("object_type", *efsc_object_type),
    Bool16("flags",
    ...
    SEnum16("lightmap_shadow_mode_size", *efsc_lightmap_shadow_mode_size),
    SEnum8("sweetener_size", *efsc_sweetener_size),
    SEnum8("water_density", *efsc_water_density),
    SInt32("unknown"),
    ...
    reflexive("early_mover_properties", efsc_early_mover_propertie),
    dependency("creation_effect"),
    dependency("material_effects"),
    dependency("melee_impact"),
    reflexive("ai_properties", efsc_ai_propertie),
    reflexive("functions", efsc_function),
    SInt16("hud_text_message_index"),
    SInt16("unknown_1"),
    reflexive("attachments", efsc_attachment),
    reflexive("widgets", efsc_widget),
    reflexive("change_colors", efsc_change_color),
    reflexive("predicted_resources", efsc_predicted_resource),
    reflexive("multiplayer_object_properties", efsc_multiplayer_object_propertie),

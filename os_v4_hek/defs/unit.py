...
seat_keyframe_action = Struct("seat keyframe action",
    ...
    BSEnum16("self seat action",
        "none",
        "exit current seat",
        "enter target seat",
        ),
    BSEnum16("target seat unit action",
        "none",
        "exit seat",
        "eject from seat",
        ),
    BSEnum16("unit door action",
        "neither",
        "open",
        "close",
        ),
    Pad(2),
    BSEnum16("apply damage to",
        "none",
        "mounted unit",
        "mounted unit region",
        "seated unit",
...
seat_access = Struct("seat access",
    ...
    BBool16("permitted ai states", *actor_states),

    SIZE=124
    )

seat_boarding = Struct("seat boarding",
    BSEnum16("boarding type",
        "immediate",
        "delayed"
        ),
    BBool16("delay until",

...
transform_in_target = Struct("transform in target",
    ...
    Struct("ai",
        ...
        Pad(2),
        BSEnum16("encounter squad handling",
            'inherit from old unit',
            'inherit from attacker',
            'free actor',
            ),
        BSEnum16("team handling",
            'inherit from old unit',
            'inherit from attacker',
            'override',
            ),
        BSEnum16("team override", *unit_teams),
        BSEnum16("initial state handling",
            'inherit',
            'override',
            ),
    ...
    Struct("vitality",
        Pad(4),
        BSEnum16("inheritance", *vitality_inheritance_overrides),
        BSEnum16("override", *vitality_inheritance_overrides),
        BFloat("shield override"),
        BFloat("health override"),
        ),
    SIZE=172
    )

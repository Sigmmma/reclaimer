...
scen_body = Struct("tagdata",
    ...
    h3_reflexive("early_mover_properties", scen_early_mover_propertie),
    h3_dependency("creation_effect"),
    h3_dependency("material_effects"),
    h3_dependency("melee_impact"),
    h3_reflexive("ai_properties", scen_ai_propertie),
    h3_reflexive("functions", scen_function),
    SInt16("hud_text_message_index"),
    SInt16("unknown_1", VISIBLE=False),
    h3_reflexive("attachments", scen_attachment),
    h3_reflexive("widgets", scen_widget),
    h3_reflexive("change_colors", scen_change_color),

...
leaf = QStruct("leaf",
    ...
    FlSInt16("v0", VISIBLE=False),
    FlSInt16("v1", VISIBLE=False),
    FlSInt16("v2", VISIBLE=False),
    FlSInt16("padding", VISIBLE=False),
...
detail_object_cell = Struct("detail_object_cell",
    QStruct("dimensions",
...
detail_object_instance = Struct("detail_object_instance",
    QStruct("pos",
        SInt8("x"), SInt8("y"), SInt8("z"),
        ORIENT="H"
        ),
    UInt8("data"),
    UInt16("color", ORIENT="H"),
    SIZE=6
    )
...
runtime_decal = Struct("runtime_decal",
    QStruct("pos", FlFloat("x"), FlFloat("y"), FlFloat("z"), ORIENT="H"),
    FlUInt16("type"),
    SInt8("yaw"),
    SInt8("pitch"),
    SIZE=16

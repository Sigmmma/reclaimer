...
permutation_bsp = Struct("permutation_bsp",
    ...
    reflexive("planes", plane, UINT16_INDEX_MAX),
    reflexive("leaves", leaf, UINT16_INDEX_MAX),
    reflexive("bsp2d_references", bsp2d_reference, 131072),
    reflexive("bsp2d_nodes", bsp2d_node, UINT16_INDEX_MAX),
...
fast_permutation_bsp = Struct("permutation_bsp",
    ...
    raw_reflexive("planes", plane, UINT16_INDEX_MAX),
    raw_reflexive("leaves", leaf, UINT16_INDEX_MAX),
    raw_reflexive("bsp2d_references", bsp2d_reference, 131072),
    raw_reflexive("bsp2d_nodes", bsp2d_node, UINT16_INDEX_MAX),

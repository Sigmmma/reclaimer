...
actv_body = Struct("tagdata",
    Bool32('flags',
        ...
        "movement_switching_try_to_stay_with_friends",
        "active_camouflage",
    ...
    SEnum16("metagame_type", TOOLTIP="Used to determine score in MCC", *mcc_actor_types),
    SEnum16("metagame_class", TOOLTIP="Used to determine score in MCC", *mcc_actor_classes),

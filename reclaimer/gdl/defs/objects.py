...
def get():
    return ObjectsPs2Def

class ObjectsPs2Def(TagDef):
    ...
    V_Normal_16_Block = { TYPE:BitStruct, NAME:"V_Normal_16",
                          INCLUDE:Compressed_Normal_16
                          }
    ...
    Object_Block = { TYPE:Struct, SIZE:64, GUI_NAME:"Object",
                     ...
                     2:{ TYPE:Bool32, OFFSET:8, GUI_NAME:"Flags",
                         0:{ NAME:"Non_Lit",   VALUE:0x0 },
                         1:{ NAME:"Fmt_Basic", VALUE:0x0 },
                      
                         2:{ NAME:"Alpha",     VALUE:0x01 },
                         3:{ NAME:"V_Normals", VALUE:0x02 },
                         4:{ NAME:"V_Colors",  VALUE:0x04 },
                         5:{ NAME:"Mesh",      VALUE:0x08 },
                         6:{ NAME:"TEX2",      VALUE:0x10 },
                         7:{ NAME:"Lmap",      VALUE:0x20 },
                     
                         8:{  NAME:"Sharp",  VALUE:0x040 },
                         9:{  NAME:"Blur",   VALUE:0x080 },
                         ...
                         14:{ NAME:"Fmt_Mask", VALUE:0x00F000 },
                         15:{ NAME:"Pre_Lit",  VALUE:0x010000 },
                         16:{ NAME:"Lit_Mask", VALUE:0x0F0000 },
                         17:{ NAME:"Lmap_Lit", VALUE:0x020000 },
                         18:{ NAME:"Norm_Lit", VALUE:0x030000 },
    ...
    Bitmap_Block = { TYPE:Struct, SIZE:64, GUI_NAME:"Bitmap",
                     ...
                     6:{ TYPE:Bool16, OFFSET:8, GUI_NAME:"Flags",
                         0:{NAME:"Halfres",   VALUE:0x001},
                         1:{NAME:"See Alpha", VALUE:0x002},
                         2:{NAME:"Clamp U",   VALUE:0x004},
                         3:{NAME:"Clamp V",   VALUE:0x008},
                         4:{NAME:"Animation", VALUE:0x010},
                         5:{NAME:"External",  VALUE:0x020},
                         6:{NAME:"Tex Shift", VALUE:0x040},
                         7:{NAME:"Has Alpha", VALUE:0x080},
                     ...
                     16:{ TYPE:UInt32Array, OFFSET:32, GUI_NAME:"Tex 0", SIZE:8},
                     17:{ TYPE:UInt32Array, OFFSET:40, GUI_NAME:"Mip TBP 1", SIZE:8},
                     18:{ TYPE:UInt32Array, OFFSET:48, GUI_NAME:"Mip TBP 2", SIZE:8},
                     
                     19:{ TYPE:UInt16Array, OFFSET:56, GUI_NAME:"VRAM Address", SIZE:4},
                     20:{ TYPE:UInt16Array, OFFSET:60, GUI_NAME:"CLUT Address", SIZE:4}
    ...
    descriptor = {TYPE:Struct, SIZE:160, GUI_NAME:"GDL Objects Resource",
                     0:{ TYPE:StrRawLatin1, OFFSET:0, GUI_NAME:"Dir Name", SIZE:32},
                     1:{ TYPE:StrRawLatin1, OFFSET:32, GUI_NAME:"Model Name", SIZE:32},
                     ...
                     CHILD:{TYPE:Container, GUI_NAME:"Data",
                            ...
                            2:{TYPE:Array, GUI_NAME:"Object Defs",
                               ...
                               SUB_STRUCT:{ TYPE:Struct, SIZE:24, GUI_NAME:"Object Def",
                                            0:{ TYPE:StrRawLatin1, NAME:"Name", SIZE:16},
                            ...
                            3:{TYPE:Array, GUI_NAME:"Bitmap Defs",
                               ...
                               SUB_STRUCT:{ TYPE:Struct, SIZE:36, GUI_NAME:"Bitmap Def",
                                            0:{ TYPE:StrRawLatin1, OFFSET:0, NAME:"Name", SIZE:16},

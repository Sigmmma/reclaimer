...
unit_damage_types   = ("s-ping", "h-ping", "s-kill", "h-kill")
unit_damage_sides   = ("front", "left", "right", "back")
unit_damage_regions = ("gut", "chest", "head",
                       "l-arm", "l-hand", "l-leg", "l-foot",
                       "r-arm", "r-hand", "r-leg", "r-foot")
unit_damage_animation_names = []
for typ in unit_damage_types:
    for side in unit_damage_sides:
        for reg in unit_damage_regions:

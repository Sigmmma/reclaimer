...
class Halo1RsrcMap(HaloMap):
    ...
    def get_meta(self, tag_id, reextract=False, **kw):
        ...
        #                                        fast-inverse square-root comments
    ...
    def meta_to_tag_data(self, meta, tag_cls, tag_index_ref, **kwargs):
        ...
        if tag_cls == "bitm":
            ...
            sequences    = meta.sequences.STEPTREE
            ...
            # calculate these since they get nulled by tool
            for sequence in sequences:
                indices = [s.bitmap_index for s in sequence.sprites.STEPTREE]

                sequence.first_bitmap_index = (indices and min(indices)) or -1
                sequence.bitmap_count = len(set(indices))

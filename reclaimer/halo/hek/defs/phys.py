...
inertial_matrix = Struct("inertial matrix",
    QuickStruct("yy_zz", GUI_NAME="yy+zz    -xy    -zx", INCLUDE=ijk_float),
    QuickStruct("zz_xx", GUI_NAME="-xy    zz+xx    -yz", INCLUDE=ijk_float),
    QuickStruct("xx_yy", GUI_NAME="-zx      -yz  xx+yy", INCLUDE=ijk_float),
    SIZE=36,
    )
...
mass_point = Struct("mass point",
    ...
    BFloat("density"),
    QuickStruct("position", INCLUDE=ijk_float),
    QuickStruct("forward", INCLUDE=ijk_float),
    QuickStruct("up", INCLUDE=ijk_float),
...
phys_body = Struct("tagdata",
    ...
    BFloat("moment scale"),
    BFloat("mass"),
    QuickStruct("center of mass", INCLUDE=xyz_float),
    BFloat("density"),

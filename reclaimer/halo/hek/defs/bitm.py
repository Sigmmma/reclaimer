...
class BitmDef(TagDef):
    ...
    Sequences_Desc = { TYPE:Struct, SIZE:64, GUI_NAME:"Sequence",
                       0:{ TYPE:StrLatin1, OFFSET:0, GUI_NAME:"Sequence Name", SIZE:32 },
    ...
    descriptor = {TYPE:Container, GUI_NAME:"bitmap",
                     0:com( {1:{ DEFAULT:"bitm" },
                                 5:{ DEFAULT:7 }
                                 }, Tag_Header),
                     ...
                     1:{ TYPE:Struct, SIZE:108, GUI_NAME:"Data",
                          ...
                          11:{ TYPE:RawDataRef, OFFSET:28, GUI_NAME:"Compressed Color Plate Data",
                               EDITABLE:False, INCLUDE:Raw_Data_Ref_Struct,
                               CHILD:{TYPE:BytearrayRaw, NAME:"Data",
                                      VISIBLE:False, SIZE:".Count"}
                               },
                          12:{ TYPE:RawDataRef, OFFSET:48, GUI_NAME:"Processed Pixel Data",
                               EDITABLE:False, INCLUDE:Raw_Data_Ref_Struct,
                               CHILD:{TYPE:BytearrayRaw, NAME:"Data",
                                      VISIBLE:False, SIZE:".Count"}
                               },

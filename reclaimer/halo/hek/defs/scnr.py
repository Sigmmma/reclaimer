...
function = Struct('function',
    ...
    dyn_senum16('scale period by'),
    BSEnum16('function', *animation_functions),
    dyn_senum16('scale function by'),
...
platoon = Struct("platoon",
    ...
    dyn_senum16("change happens to"),

    Pad(8),
    BSEnum16("manuever when", *manuever_when_states),
    dyn_senum16("manuever happens to"),
    SIZE=172
    )
...
participant = Struct("participant",
    ...
    dyn_senum16("use this object"),
    dyn_senum16("set new name"),

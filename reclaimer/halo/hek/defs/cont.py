...
point_state = Struct("point state",
    Struct("state duration", INCLUDE=from_to),
    Struct("state transition duration", INCLUDE=from_to),
    dependency("physics", valid_point_physics),
    Pad(32),
    BFloat("width"),
    Struct("color lower bound", INCLUDE=argb_float),
    Struct("color upper bound", INCLUDE=argb_float),
    BBool32("scale flags",
        "duration",
        "duration delta",
        "transition duration",
...
cont_body = Struct("tagdata",
    ...
    Struct("point creation",
        ...
        Struct("veloctiy", INCLUDE=from_to),

...
particle_type = Struct("particle_type",
    ...
    float_wu("fade-in start distance"),
    float_wu("fade-in end distance"),
    float_wu("fade-out start distance"),
    float_wu("fade-out end distance"),
    float_wu("fade-in start height"),
    float_wu("fade-in end height"),
    float_wu("fade-out start height"),
    float_wu("fade-out end height"),

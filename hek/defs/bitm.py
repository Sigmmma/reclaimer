...
bitmap = Struct("bitmap",
    BUEnum32('bitm id', ('bitm', 'bitm'), DEFAULT='bitm', EDITABLE=False),
    BUInt16("width", SIDETIP="pixels", EDITABLE=False),
    BUInt16("height", SIDETIP="pixels", EDITABLE=False),
    BUInt16("depth", SIDETIP="pixels", EDITABLE=False),
    BSEnum16("type",
        "texture 2d",
        "texture 3d",
        "cubemap",
...
bitm_body = Struct("tagdata",
    ...
    QStruct("post processing",
        ...
        BFloat("bump height", SIDETIP="repeats"),
    ...
    BUInt16("color plate width",  SIDETIP="pixels", EDITABLE=False),
    BUInt16("color plate height", SIDETIP="pixels", EDITABLE=False),

...
smet_attrs = Struct("smet attrs",
    ...
    Struct("external function sources",
        BSEnum16("meter brightness", *function_outputs),
        BSEnum16("flash brightness", *function_outputs),
        BSEnum16("value",            *function_outputs),
        BSEnum16("gradient",         *function_outputs),
        BSEnum16("flash-extension",  *function_outputs),
        ),
    SIZE=220,
    )

...
scnr_body = Struct("tagdata",
    ...
    reflexive("controls palette", control_swatch, 100,
        DYN_NAME_PATH='.name.filepath'),
    reflexive("light fixtures", light_fixture, 500, IGNORE_SAFE_MODE=True),
    reflexive("light fixtures palette", light_fixture_swatch, 100,
        DYN_NAME_PATH='.name.filepath'),
    reflexive("sound sceneries", sound_scenery, 256, IGNORE_SAFE_MODE=True),
    ...
    reflexive("ai conversations", ai_conversation, 128,
        DYN_NAME_PATH='.name'),
    rawdata_ref("script syntax data", max_size=380076, IGNORE_SAFE_MODE=True),
    rawdata_ref("script string data", max_size=262144, IGNORE_SAFE_MODE=True),

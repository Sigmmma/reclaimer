...
class BipdTag(ObjeTag):
    ...
    def calc_internal_data(self):
        ...
        physics.negative_sine_downhill_falloff_angle = -sin(movement.downhill_falloff_angle)
        physics.negative_sine_downhill_cutoff_angle  = -sin(movement.downhill_cutoff_angle)
